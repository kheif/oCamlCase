...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { num: '10.', label: 'Higher-Order Functions', path: '/concepts/higher-order' },
      { num: '11.', label: 'Tail Recursion', path: '/concepts/tail-recursion' },
      { num: '12.', label: 'Iteration', path: '/concepts/iteration' },
      { num: '13.', label: 'Derived Forms', path: '/concepts/derived-forms' },
    ],
  },
  {
    label: 'Exercises',
